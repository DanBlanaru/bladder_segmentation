...
raw_dir = "/data/dan_blanaru/original_data/AMOS22/"
...
os.makedirs(processed_tr_dir, exist_ok=True)
...
if create_log:
    ...
    print(
        f"{csv_path},{'exists' if os.path.exists(csv_path) else 'didnt exist, created'}"
    )
...
if copy_json:
    dataset_json["labels"] = {"0": "background", "1": "bladder"}
